...
配置 reloadcmd
```
acme.sh --config-home "/user/acme/example" --install-cert -d ghostliner.top --reloadcmd "/root/acme/upsert.py -h example.com -p /root/acme/example.com/example.com_ecc"
```
